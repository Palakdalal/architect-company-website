        ...
        <div className={classes.container}>
            <div className={classes.wrapper}>
                ...
                <div className={classes.catalog}>
                    ...
                    {activeBtn === 1 && (
                        <>
                            {listedYachts?.length > 0 && <h2 className={classes.title}>Listed Backyards</h2>}
                            ...
                            ) : <h2 className={classes.noListed}>You have no listed Backyards</h2>}
                        </>
                    )}
                    {activeBtn === 2 && (
                        <>
                    ...
                    {activeBtn === 3 && (
                        <>
                            {bookmarkedYachts?.length > 0 && <h2 className={classes.title}>Bookmarked backyards</h2>}
                            ...
                            ) : <h2 className={classes.noListed}>You have no bookmarked Houses</h2>}
                        </>
                    )}
                </div>
                {error && (
